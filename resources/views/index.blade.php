...
<body>
    <nav class="navbar">
        <div class="logo">
            <img src="{{ asset('storage/images/logo.png') }}" alt="Paxful Logo">
        </div>
    ...
    <script>
        ...
        <section class="hero">
            ...
            <div class="cta-buttons">
                ...
                <button class="cta-button track-button" style="background-color:#E6CE9C; border-radius: 999px;"><a href="/login">Track Payment</a></button>

                <p>Accept The Payment To Receive The Funds Instantly.</p>
                <button class="cta-button accept-button" style="background-color:#007BFF; border-radius: 999px;"><a href="/login">Accept Payment</a></button>

                <p>Cancel The Payment To Decline The Funds, And The Sender Will Be Refunded <br>Immediately.</p>
                <button class="cta-button cancel-button" style="background-color:#f08080; border-radius: 999px;">Cancel The Transfer</button>
            </div>
        </section>
        ...
        <section class="features">
                ...
                <div class="features__content">
                    <div class="features__column">
                        <div class="features__item">
                            <img src="{{ asset('storage/images/paxfulimg.PNG') }}" class="features__image">
                    ...
                    <div class="features__column">
                        <div class="features__item">
                        <img src="{{ asset('storage/images/noones.PNG') }}" class="features__image">
                    ...
                    <div class="features__column">
                        <div class="features__item">
                        <img src="{{ asset('storage/images/bybit.PNG') }}" class="features__image">
                ...
                <div class="features__content">
                    <div class="features__column">
                        <div class="features__item">
                        <img src="{{ asset('storage/images/localcoinswap.PNG') }}" class="features__image">
                    ...
                    <div class="features__column">
                        <div class="features__item">
                        <img src="{{ asset('storage/images/deriv.PNG') }}" class="features__image">
                    ...
                    <div class="features__column">
                        <div class="features__item">
                        <img src="{{ asset('storage/images/coinbase.PNG') }}" class="features__image">
